...
// Styles for SRI KARYA MUKTI template (Orange theme)
...
export function SriKaryaMuktiTemplate({
    invoiceNumber,
    invoiceDate,
    items,
    customerName = 'SPPG Pandansari',
}: SriKaryaMuktiTemplateProps) {
            ...
            <Page size="A4" style={styles.page}>
                ...
                <View style={styles.header}>
                    <View style={styles.companyBlock}>
                        <Image
                            src={getAssetPath('/assets/sri-karya-mukti/logo.png')}
                            style={styles.logo}
                        />
                        <View style={styles.companyText}>
                            <Text style={styles.companyName}>SRI KARYA MUKTI</Text>
                            <Text style={styles.companyAddress}>
                                Cihonje RT 3 RW 11, Desa/Kelurahan Cihonje, Kec. Gumelar, Kab. Banyumas, Provinsi Jawa Tengah. Kode Pos 53165
                            </Text>
                        </View>
                    </View>
                ...
                <View style={styles.footer}>
                    <View style={styles.paymentInfo}>
                        ...
                        <Text>BNI - 2003608397</Text>
                    </View>

                    <View style={styles.signatureSection}>
                        <View style={styles.signatureRow}>
                            <Image
                                src={getAssetPath('/assets/sri-karya-mukti/signature.png')}
